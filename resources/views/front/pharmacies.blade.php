											...
											<div class="single-pharmacylist-view">
												...
												<div class="pharmacy-content p-5">
													<h3 class="name p-5"><a href="product-details.html">
                                                        <i class="lni lni-user"></i> صيدلية ياسين </a></h3>
													<ul class="address ">
														<li>
															<a href="javascript:void(0)"><i class="lni lni-map-marker"></i> تعز المسبح</a>
														</li>
													</ul>
					...
					<div class="col-lg-4">
                        ...
                        <div class=" box-style col-md-12">
                            <div class="right-wrapper">
                                ...
                                <ul class="nav pharmacy-view-btnsd-flex justify-content-between" id="myTab" role="tablist">
                                     <li class="product-view-item" role="presentation">
                                      <h3>طريقة العرض</h3>
                                    </li>
                                    <li class="product-view-item" role="presentation">
                                        <a class="pharmacy-view-btns" id="list-tab" data-toggle="tab" href="#list" role="tab" aria-controls="list"
                                            aria-selected="true"><i class="lni lni-list"></i></a>
                                    </li>
                                    <li class="product-view-item" role="presentation">
                                        <a class="pharmacy-view-btns active" id="grid-tab" data-toggle="tab" href="#grid" role="tab" aria-controls="grid"
